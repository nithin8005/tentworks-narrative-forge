  ...
  return (
    <PageShell>
      ...
      <section className="mx-auto max-w-5xl px-4 py-24 sm:px-6 lg:px-8">
        ...
        <div className="mt-20 rounded-2xl border border-border/60 bg-card/50 p-10">
...
function Milestone({ year, text }: { year: string; text: string }) {
  return (
    <li className="flex items-baseline gap-6 border-b border-border/40 pb-3 last:border-0">
