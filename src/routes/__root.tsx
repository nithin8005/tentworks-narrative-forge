...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Tentworks Interactive — Story-Driven Strategy Games" },
      { name: "description", content: "Independent game studio crafting deep, narrative-rich strategy experiences. Makers of Becoming Pablo." },
      { name: "author", content: "Tentworks Interactive" },
