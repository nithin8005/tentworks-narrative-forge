  ...
  return (
    <PageShell>
      ...
      <section className="mx-auto max-w-7xl px-4 pb-24 sm:px-6 lg:px-8">
        <FadeUp as="article" className="grid gap-10 overflow-hidden rounded-2xl border border-border/60 bg-card/40 p-8 lg:grid-cols-2 lg:p-12">
          ...
          <div>
            ...
            <StaggerGroup as="dl" className="mt-6 grid grid-cols-2 gap-4 text-sm" stagger={0.08}>
...
function Tag({ k, v }: { k: string; v: string }) {
  return (
    <StaggerItem className="rounded-md border border-border/60 bg-background/40 p-3">
